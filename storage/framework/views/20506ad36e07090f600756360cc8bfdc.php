            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="<?php echo e(route('admin.parser.collectLinksForm')); ?>" class="btn btn-outline-success me-2">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.parser.batchParse')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group mb-3">
                            ...
                            <textarea 
                                class="form-control <?php $__errorArgs = ['urls'];
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                required
                            ><?php echo e(old('urls')); ?></textarea>
                            <?php $__errorArgs = ['urls'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4">
                        <div class="alert alert-info">
                            ...
                            <p>
                                <strong>Совет:</strong> Используйте сначала <a href="<?php echo e(route('admin.parser.collectLinksForm')); ?>">страницу сбора ссылок</a> для автоматического извлечения URL рецептов с целой категории.
                            </p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\eats\resources\views/admin/parser/batch.blade.php ENDPATH**/ ?>