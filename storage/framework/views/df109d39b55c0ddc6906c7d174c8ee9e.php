        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 animate-on-scroll">
                    <a href="<?php echo e(route('recipes.index')); ?>" class="btn btn-primary btn-lg px-4 me-md-2">
                        <i class="fas fa-book-open me-1"></i> Все рецепты
                    </a>
                    <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-outline-secondary btn-lg px-4">
                        <i class="fas fa-tags me-1"></i> Категории
                    </a>
                </div>
                
                <form action="<?php echo e(route('search')); ?>" method="GET" class="mt-4 animate-on-scroll">
...
<div class="search-container bg-white p-3 rounded shadow-sm my-4">
    ...
    <div class="tab-content p-3" id="searchTabsContent">
        ...
        <div class="tab-pane fade" id="ingredient-search" role="tabpanel">
            <form action="<?php echo e(route('search')); ?>" method="GET" id="ingredients-search-form">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('recipes.index')); ?>" class="btn btn-outline-primary animate-on-scroll">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 animate-on-scroll" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                        <?php if($recipe->image_url): ?>
                        <img src="<?php echo e($recipe->image_url); ?>" class="card-img-top recipe-image" alt="<?php echo e($recipe->title); ?>">
                        <?php else: ?>
                        <div class="no-image">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text recipe-time">
                                <i class="fas fa-clock"></i> <?php echo e($recipe->cooking_time); ?> мин.
                            </p>
                            <?php endif; ?>
                        </div>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-outline-primary animate-on-scroll">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 category-card text-center animate-on-scroll" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                        <div class="card-body">
                            ...
                            <p class="text-muted">
                                <span class="animate-number" data-target="<?php echo e($category->published_recipes_count); ?>">0</span> рецептов
                            </p>
                        </div>
                        <div class="card-footer">
                            <a href="<?php echo e(route('categories.show', $category->slug)); ?>" class="btn btn-outline-primary w-100">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card animate-on-scroll">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php $__currentLoopData = $quickRecipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-0 shadow-sm animate-on-scroll" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                                <?php if($recipe->image_url): ?>
                                <img src="<?php echo e($recipe->image_url); ?>" class="card-img-top recipe-image" alt="<?php echo e($recipe->title); ?>">
                                <?php else: ?>
                                <div class="no-image">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo e($recipe->title); ?></h5>
                                    <p class="card-text recipe-time">
                                        <i class="fas fa-clock text-primary"></i> <?php echo e($recipe->cooking_time); ?> мин.
                                    </p>
    ...
    <div class="row">
        <div class="col-12">
            <div class="p-5 text-center bg-light rounded-3 mb-4 animate-on-scroll">
                ...
                <?php else: ?>
                <a href="<?php echo e(route('admin.recipes.create')); ?>" class="btn btn-primary btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\eats\resources\views\welcome.blade.php ENDPATH**/ ?>