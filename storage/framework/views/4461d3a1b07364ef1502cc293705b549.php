...
unset($__errorArgs, $__bag); ?>" name="bio" rows="4"><?php echo e(old('bio', $user->bio)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <?php if($user->avatar): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e(asset('storage/'.$user->avatar)); ?>" alt="Current avatar" class="img-thumbnail" style="max-height: 100px;">
                                    </div>
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="<?php echo e(route('profile.show')); ?>" class="btn btn-secondary ms-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\eats\resources\views\profile\edit.blade.php ENDPATH**/ ?>