        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mb-4">
                <p class="mb-0">
                    ...
                    Рецепт будет создан от имени <?php echo e(auth()->user()->name); ?> 
...
unset($__errorArgs, $__bag); ?>" id="ingredients" name="ingredients" rows="6" placeholder="Введите каждый ингредиент с новой строки" required><?php echo e(old('ingredients')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="instructions" name="instructions" rows="8" placeholder="Введите каждый шаг с новой строки" required><?php echo e(old('instructions')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="cooking_time" name="cooking_time" min="1" value="<?php echo e(old('cooking_time')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group mb-4">
                    <div class="form-check">
                        <input class="form-check-input <?php $__errorArgs = ['terms_agreement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="checkbox" id="terms_agreement" name="terms_agreement" required>
                        <label class="form-check-label" for="terms_agreement">
                            Публикуя рецепт, я подтверждаю, что имею права на размещение всех материалов и согласен с <a href="<?php echo e(route('legal.terms')); ?>" target="_blank">пользовательским соглашением</a>.
                        </label>
