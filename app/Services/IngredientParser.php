...
{
    /**
     * Разбирает строку с ингредиентами и преобразует в структурированный массив
     *
     * @param string $ingredientsText Текст с ингредиентами (разделенный переносами строк)
     * @return array Массив структурированных ингредиентов
     */
    public function parseIngredients(string $ingredientsText): array
    {
        $lines = explode("\n", $ingredientsText);
