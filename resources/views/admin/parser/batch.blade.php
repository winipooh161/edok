            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('admin.parser.collectLinksForm') }}" class="btn btn-outline-success me-2">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div class="alert alert-info">
                            ...
                            <p>
                                <strong>Совет:</strong> Используйте сначала <a href="{{ route('admin.parser.collectLinksForm') }}">страницу сбора ссылок</a> для автоматического извлечения URL рецептов с целой категории.
                            </p>
                        </div>
                    </div>
                </div>
