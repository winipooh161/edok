        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.parser.collectLinks') }}">
                        @csrf
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input 
                                    type="url" 
                                    class="form-control @error('category_url') is-invalid @enderror" 
                                    id="category_url" 
                                    name="category_url" 
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input 
                                type="text" 
                                class="form-control @error('link_selector') is-invalid @enderror" 
                                id="link_selector" 
                                name="link_selector" 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input 
                                        type="text" 
                                        class="form-control @error('pagination_selector') is-invalid @enderror" 
                                        id="pagination_selector" 
                                        name="pagination_selector" 
                                        placeholder=".pagination a, .pages-nav .page-link"
                                        value="{{ old('pagination_selector', '.emotion-1vzb8pn a') }}"
                                    >
                                    @error('pagination_selector')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input 
                                        type="number" 
                                        class="form-control @error('desired_links') is-invalid @enderror" 
                                        id="desired_links" 
                                        name="desired_links" 
                                        min="1" 
                                        max="500"
                                        value="{{ old('desired_links', 100) }}"
                                    >
                                    @error('desired_links')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select 
                                        class="form-select @error('scroll_mode') is-invalid @enderror" 
                                        id="scroll_mode" 
                                        name="scroll_mode"
                                    >
                                        <option value="disabled" {{ old('scroll_mode') == 'disabled' ? 'selected' : '' }}>Без прокрутки (стандартно)</option>
                                        <option value="enabled" {{ old('scroll_mode', 'enabled') == 'enabled' ? 'selected' : '' }}>С прокруткой (расширенный поиск)</option>
                                    </select>
                                    @error('scroll_mode')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="collect_images" name="collect_images" value="1" {{ old('collect_images') ? 'checked' : '' }}>
