            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>1.1. Настоящее Пользовательское соглашение (далее — «Соглашение») регламентирует отношения между администрацией сайта "Я едок" (далее — «Администрация»), и любым физическим лицом (далее — «Пользователь»), использующим сервисы и материалы, размещенные на сайте {{ config('app.url') }} (далее — «Сайт»).</p>
